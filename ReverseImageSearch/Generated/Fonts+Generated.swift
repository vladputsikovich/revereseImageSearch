...
internal enum FontFamily {
  internal enum SFProDisplay {
    ...
    internal static let thin = FontConvertible(name: "SFProDisplay-Thin", family: "SF Pro Display", path: "SF-Pro-Display-Thin.ttf")
    ...
    internal static let all: [FontConvertible] = [blackItalic, bold, heavyItalic, lightItalic, medium, regular, semiboldItalic, thin, thinItalic, ultralightItalic]
  }
